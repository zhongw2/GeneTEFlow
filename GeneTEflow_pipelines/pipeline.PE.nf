...
if ((params.DESeq_run_tag == "Y" ) && (params.analysis_pipeline_run_tag == "Y"))
{
    process sigGene{
         ...
         """    
         Rscript $params.sigGene_cmd $deseqout  $tpmdata  $sampleinfotxt  $samplecomparetxt  $params.deseq.fdr.gene  $params.deseq.log2FC.gene  $params.deseq.gmean.gene  >    sigGene.log   2>&1
         """
...
if (params.TE_pipeline_run_tag == "Y" ) {
    process squireFetch  {
     ...
     process squireMap  {
         ...
         """
         squire  Map  -1   ${pair_id}_1.clipped.fastq.gz   -2  ${pair_id}_2.clipped.fastq.gz      -o  ${pair_id}.squire_map_folder  -r  150  -n  ${pair_id}  -b  $params.squireFetch.genome   --gtf  squire_fetch/hg38_refGene.gtf  -p  $params.cpu  -v  >squire_Map_${pair_id}.log  2>squire_Map_${pair_id}.err.log
         """
